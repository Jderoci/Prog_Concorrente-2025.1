...
public class FutureHello  {
  ...
  private static final int TESTE_PRIMOS = 1000000; // Quantidade de primos testados
  ...
  public static void main(String[] args) {
    ...
    // Contagem de primos
    List<Future<Boolean>> futurosPrimos = new ArrayList<>();
    for (int i = 1; i <= TESTE_PRIMOS; i++) {
      futurosPrimos.add(executor.submit(new VerificaPrimo(i)));
    }

    int totalPrimos = 0;
    for (Future<Boolean> f : futurosPrimos) {
      try {
    ...
    System.out.println("Total de primos entre 1 e " + TESTE_PRIMOS + " é:" + totalPrimos);
